...
The total width of the box is 400px (width of content) + 10px _ 2 (padding-left and padding-right) + 30px (margin-left) + 2px _ 2 (border-left and border-right) ======= 454px. Our content is 400px, but the width of the box is 454px.
